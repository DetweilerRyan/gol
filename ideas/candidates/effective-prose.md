...
- **Nothing in the pipeline runs the linter.** `npm run prose-lint` exists, no role invokes it, and it
  ...
  made it answerable: `scope-prose-lint-then-give-roles-the-trigger` gives the three roles that write
  JSDoc and module sidecars a trigger, once the runner can be scoped to a slice.
...
| Slice                                                | Why first                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `scope-prose-lint-then-give-roles-the-trigger`       | **Ruled 2026-09-12 and promoted.** A role trigger for `coder`, `cleaner` and `architect`, after the runner accepts a path scope. The no-role-edits law is what made it answerable: a role can now dirty only JSDoc and module sidecars, so a finding it sees is a finding it owns. No `hardener` stage — three of six rules need judgement, so the tool cannot gate on findings.                                                                                                                                                                                                                                                  |
