...
1. Is it a **procedure the orchestrating session executes**, or a **predicate that gates** (a path allowlist, a rule index a checker reads)? → CLAUDE.md. It has no other instruction surface.
