 ...
 * will flag it as unresolved. Caught during this program's own development:
 * an early draft of one of these doc comments did exactly that. Angle
 * brackets are the escape hatch, since `<` falls outside this regex's
 * character class -- write a hypothetical example as `npm run
 * <script-name>`, never a bare word that isn't a real package.json script.
 */
