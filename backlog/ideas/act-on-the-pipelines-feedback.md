...
| #   | Child                                                   | Carries                                                                                                                                                                                                                                       |
| --- | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `backlog/ideas/revise-the-pipelines-reference.md`       | Items 1, 2, 3, 6 — the spike as an optional Story sub-pipeline, mode-bearing cycle strings (the check-4 fork resolved in-slice), the VERIFY→ADJUDICATE loop drawn, the required Enabler design pass — with item 8's `prose-lint` step listed. |
| 2   | `backlog/ideas/extract-the-merge-protocol.md`           | Item 4 — the merge protocol out of CLAUDE.md into `.claude/references/`, every source-of-truth citation repointed in the same slice, routing branch 1's rationale restated.                                                                   |
