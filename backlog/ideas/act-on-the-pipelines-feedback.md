...
| #   | Child                                                                            | Carries                                                                                                                                                                                                                                       |
| --- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `backlog/ready/revise-the-pipelines-reference/proposal.md` (promoted 2026-09-17) | Items 1, 2, 3, 6 — the spike as an optional Story sub-pipeline, mode-bearing cycle strings (the check-4 fork resolved in-slice), the VERIFY→ADJUDICATE loop drawn, the required Enabler design pass — with item 8's `prose-lint` step listed. |
