...
| 3   | `backlog/ready/wire-in-the-adr-tier/proposal.md` (promoted 2026-09-16)                             | `adr/0001` recording the board decision with the reevaluation's declines as Options considered, the stale `adr/README.md` reservation fix, and `architect.md`'s `adr/` read trigger. Independent.                                                 |
