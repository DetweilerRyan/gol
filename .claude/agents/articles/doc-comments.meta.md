...
<!-- reference-check: allow useZoomGlide.md -- a quoted probe input in the measurement table below, testing the path form TypeDoc was evaluated against; the sidecar itself is useZoomGlide.meta.md, and no useZoomGlide.md exists -->
